...
It uses Fireworks' serverless inference API (with `echo=true`) to fetch input logprobs on the semantic parts of the page, then highlights the tokens below a logprob threshold.
